...
"equations" => stripslashes($_POST['Equations']),
"references" => stripslashes(unicode_escape_sequences($_POST['References'])),
"textreferences" => stripslashes(unicode_escape_sequences($_POST['TextReferences'])),
"equationCount"=>  stripslashes($_POST['EquationCount']),
"referencecount"=>  stripslashes($_POST['ReferenceCount']),
"textreferencecount"=> stripslashes($_POST['TextReferenceCount']),
"html_code" => stripslashes($_POST['HTML']),
"subequationcount" => stripslashes($_POST['subEquationCount'])
));
