	...
	<body onload="body_load()">
		<div class="container_12" id="main-container">
			...
			<div id="wrapper">
				<div class="grid_3" id="sidebar">
					<div id="main-menu">
						<div id="standard">
							...
							<button onclick="newReference()">
								+reference
							</button>
							<button onclick="rerender()">
								+rerender
							</button>
							<button onclick="newTextReference()">
								+teference
							</button>
							<button onclick="EquationReference();">
								+eference
							</button>
				...
				<div class="grid_9" id="editor-container">
					<div id="toolbar">
						<button id="toolbar_button" onclick="Bold();" title="Bold">
							<b>B</b>
						</button>
						<button id="toolbar_button" onclick="Italic();" title="Italic">
							<em>I</em>
						</button>
						<button id="toolbar_button" onclick="Underline();" title="Underline">
							<ins>U</ins>
						</button>
						<button id="toolbar_button" onclick="Center();" title="Align Center"><img src="images/Align_center_button.gif" />
						</button>
						<button id="toolbar_button" onclick="Justify();" title="Justify"><img src="images/Align_force_button.png" />
						</button>
						<button id="toolbar_button" onclick="Left();" title="Align Left"><img src="images/Align_left_button.gif" />
						</button>
						<button id="toolbar_button" onclick="Right();" title="Align Right"><img src="images/Align_right_button.gif" />
						</button>
						<button id="toolbar_button" onclick="Link();" title="Add Hyperlink">
							<ins style="color:blue">Add Link</ins>
						</button>
						<button id="toolbar_button" onclick="UnLink();" title="Remove Hyperlink">
							UnLink
						</button>
						<button id="toolbar_button" onclick="Sub();" title="Subscript"><img src="images/subscript.png" />
						</button>
						<button id="toolbar_button" onclick="Sup();" title="Superscript"><img src="images/superscript.png" />
						</button>
						<script>
							document.write('<select id="toolbar_button" title="FontSize" ');
							if (window.chrome)
								document.write('onclick="this.options[this.selectedIndex].onclick()" ');
							// onclick event for chrome
						...
						<button id="toolbar_button" onclick="showColor();" title="FontColor">
							FontColor >>
						</button>
						<div id="font_color" onclick="showColor();">
							<img src="images/color.png" border="0" usemap="#Map" />
							<map name="Map" id="Map">
					...
					<div class = 'qs'>
						<a href="./Mathifold.pdf" target="_blank" >Quick Start Guide ↗</a>
					</div>
					<!--end of div#editor-->
				</div>
		...
		<div  id="equation-container">
			<div  class="palette">
				...
				<span onclick="addStep();" style="cursor:pointer;" id="plus-step">+step</span>
			</div>
